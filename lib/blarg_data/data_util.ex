defmodule DataUtil do
  ...
  def credits_base_path do
    Path.join([Application.app_dir(:blarg), "priv/static/text/credits"])
  end

  def synopses_base_path do
    Path.join([Application.app_dir(:blarg), "priv/static/text/synopses"])
  end

  def bios_base_path do
    Path.join([Application.app_dir(:blarg), "priv/static/text/bios"])
  end
